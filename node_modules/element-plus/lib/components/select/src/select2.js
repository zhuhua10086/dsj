...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.createVNode(_component_el_tooltip, {
            ...
            vue.createElementVNode("div", {
              ...
              !_ctx.selectDisabled ? (vue.openBlock(), vue.createElementBlock("div", {
                ...
                vue.withDirectives(vue.createElementVNode("input", {
                  ...
                  onKeydown: [
                    _cache[3] || (_cache[3] = vue.withKeys(vue.withModifiers(($event) => _ctx.navigateOptions("next"), ["prevent"]), ["down"])),
                    _cache[4] || (_cache[4] = vue.withKeys(vue.withModifiers(($event) => _ctx.navigateOptions("prev"), ["prevent"]), ["up"])),
                    _cache[5] || (_cache[5] = vue.withKeys((...args) => _ctx.handleEsc && _ctx.handleEsc(...args), ["esc"])),
                    ...
                    _cache[8] || (_cache[8] = vue.withKeys(($event) => _ctx.expanded = false, ["tab"]))
                  ],
      ...
      content: vue.withCtx(() => [
        vue.createVNode(_component_el_select_menu, { ref: "menuRef" }, vue.createSlots({
          default: vue.withCtx(() => [
            ...
            _ctx.loading || _ctx.filteredOptionsCount === 0 ? vue.renderSlot(_ctx.$slots, "empty", { key: 0 }, () => [
